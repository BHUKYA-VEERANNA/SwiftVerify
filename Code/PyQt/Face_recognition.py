...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_dir", type=str, default="C:/Users/bveer/OneDrive/Desktop/Major Project/Code/PyQt/resources/anti_spoof_models", help="model library used to test")
